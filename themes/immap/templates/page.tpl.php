...
<div id="page">
  ...
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','immap')): ?>
  <?php 
    $slide1_head = check_plain(theme_get_setting('slide1_head','immap'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','immap'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','immap'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','immap'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','immap'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','immap'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','immap'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','immap'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','immap'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'immap') . '/images/slide-1.png'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'immap') . '/images/slide-2.png'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'immap') . '/images/slide-3.png'; ?>"/>
      ...
      <div class="row">
        <div class="container">
          <?php if (theme_get_setting('breadcrumbs')): ?>
            <?php if ($breadcrumb): ?><div id="breadcrumbs">
              <?php print $breadcrumb; ?></div>
            <?php endif;?>
          <?php endif; ?>
          <?php print render($title_prefix); ?>
          <?php if ($title): ?><h1 class="page-title" id="text-bc"><?php print $title; ?></h1><?php endif; ?>
    ...
    <div class="container">
      <div class="row">
        <div class="fcred col-sm-12">
          <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Custom Theme by'); ?>  <a href="http://www.rzqbuchek.com" target="_blank">RzQBuchek</a>.
        </div>
      </div>
    </div>
  </div>
